...
module.exports = {
    name: "recent",
    description: "(beta) Print the songs played previously. (Up to 25, default is 5)",
    args: false,
    ...
    execute(message, args, client) {
        return message.channel.send("This command is currently under development, check back later!");
